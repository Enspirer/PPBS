...
<div class="">
   <div class="col-md-12">
      <div class="invoice p-5">
               ...
               <address class="mt-2 mb-2">
                  <strong class="text-inverse" style="border-bottom:1px solid #23282c;">Traveller Information</strong><br>
                     <table class="mt-3" width="380px">
                        <tr>
                           <td><h6 class="text-inverse mb-3">Name:</h6></td>
                           <td><h6 class="text-inverse mb-3">{{$booking_print->customer_name}}</h6></td>
                        </tr>
                        <tr>
                           <td><h6 class="text-inverse mb-3">Email:</td>
                           <td><h6 class="text-inverse mb-3">{{$booking_print->customer_email}}</h6></td>
                        </tr>
                        <tr>
                           <td><h6 class="text-inverse mb-3">Phone:</td>
                           <td><h6 class="text-inverse mb-3">{{$booking_print->customer_telephone}}</h6></td>
                        </tr>
                     </table>
               </address>
            ...
            <div class="invoice-to">
               <address class="mt-2 mb-2">
                  <strong class="text-inverse" style="border-bottom:1px solid #23282c;">Carrier Details</strong><br>
                     <table class="mt-3" width="380px">
                        <tr>
                           <td><h6 class="text-inverse mb-3">Adults:</td>
                           <td><h6 class="text-inverse mb-3">{{$booking_print->adults}}</h6></td>
                        </tr>
                        <tr>
                           <td><h6 class="text-inverse mb-3">Children:</td>
                           <td><h6 class="text-inverse mb-3">{{$booking_print->child}}</h6></td>
                        </tr>
                        <tr>
                           <td><h6 class="text-inverse mb-3">Babies:</td>
                           <td><h6 class="text-inverse mb-3">{{$booking_print->baby}}</h6></td>
                        </tr>
                        <tr>
                           <td><h6 class="text-inverse mb-3">Passengers:</h6></td>
                           <td><h6 class="text-inverse mb-3">{{$booking_print->passengers_count}}</h6></td>
                        </tr>
                        <tr>
                           <td><h6 class="text-inverse mb-3">Vehicle Number:</td>
                           <td><h6 class="text-inverse mb-3">{{$booking_print->vehicle_number}}</h6></td>
                        </tr>
                        <tr>
                           <td><h6 class="text-inverse mb-3">Luggages:</td>
                           <td><h6 class="text-inverse mb-3">{{$booking_print->number_of_luggages}}</h6></td>
                        </tr>
                     </table>
               </address>
            </div>            
            ...
            <div class="invoice-from">
               <address class="mt-2 mb-2">
                  <strong class="text-inverse" style="border-bottom:1px solid #23282c;">Pick-up Information</strong><br>
                     <table class="mt-3" width="380px">
                        <tr>
                           <td><h6 class="text-inverse mb-3">From:</h6></td>
                           <td>
                              <h6 class="text-inverse mb-3">
                        ...
                        <tr>
                           <td><h6 class="text-inverse mb-3">Date:</td>
                           <td><h6 class="text-inverse mb-3">{{$booking_print->pickup_date}}</h6></td>
                        </tr>
                        <tr>
                           <td><h6 class="text-inverse mb-3">Time:</td>
                           <td><h6 class="text-inverse mb-3">{{$booking_print->pickup_time}}</h6></td>
                        </tr>
                        <tr>
                           <td><h6 class="text-inverse mb-3">Address:</td>
                           <td><h6 class="text-inverse mb-3">{{$booking_print->pickup_address}}</h6></td>
                        </tr>
                     </table>
               </address>
         ...
         <div class="invoice-header">
            <div class="invoice-from">
               <table class="mt-3" width="30%">                        
                  <tr>
                     <td><h6 class="text-inverse mb-3">Booking Type:</td>
                     <td><h6 class="text-inverse mb-3">{{$booking_print->booking_type}}</h6></td>
                  </tr>
                  <tr>
                     <td><h6 class="text-inverse mb-3">Total Price:</td>
                     <td><h6 class="text-inverse mb-3">&euro;{{$booking_print->total_price}}</h6></td>
                  </tr>
                  <tr>
                     <td><h6 class="text-inverse mb-3">Payment Method:</td>
                     <td><h6 class="text-inverse mb-3">{{$booking_print->payment_method}}</h6></td>
                  </tr>
               </table>               
            </div>                        
         </div>
            ...
            @if($booking_print->booking_type == 'Return')
               ...
               <div class="invoice-header">
                  <div class="invoice-from">
                     <table class="mt-3" >                        
                        <tr>
                           <td width="15%"><h6 class="text-inverse mb-3">Pick Up Address:</td>
                           <td><h6 class="text-inverse ml-3 mb-3">{{$booking_print->return_pickup_address}}</h6></td>
                        </tr>
                        <tr>
                           <td><h6 class="text-inverse mb-3">Drop Address:</td>
                           <td><h6 class="text-inverse ml-3 mb-3">{{$booking_print->return_drop_address}}</h6></td>
                        </tr>
                        <tr>
                           <td><h6 class="text-inverse mb-3">Vehicle Number:</td>
                           <td><h6 class="text-inverse ml-3 mb-3">{{$booking_print->return_vehicle_number}}</h6></td>
                        </tr>
                        <tr>
                           <td><h6 class="text-inverse mb-3">Passengers Count:</td>
                           <td><h6 class="text-inverse ml-3 mb-3">{{$booking_print->return_passengers_count}}</h6></td>
                        </tr>
                        <tr>
                           <td><h6 class="text-inverse mb-3">Departure Date:</td>
                           <td><h6 class="text-inverse ml-3 mb-3">{{$booking_print->departure_date}}</h6></td>
                        </tr>
                        <tr>
                           <td><h6 class="text-inverse mb-3">Departure Time:</td>
                           <td><h6 class="text-inverse ml-3 mb-3">{{$booking_print->departure_time}}</h6></td>
                        </tr>
                        <tr>
         ...
         <div class="invoice-footer mt-5 p-3 text-center" style="margin:20px 0 20px 0; border-top: 2px solid #A9A9A9; border-bottom: 2px solid #A9A9A9">
