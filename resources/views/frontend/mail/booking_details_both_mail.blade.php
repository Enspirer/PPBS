    ...
    <div class="col-md-12">
        <div class="invoice p-5">
            ...
            <div class="invoice-content">
                ...
                @if($booking_details['booking_type'] == 'Return')

                <div class="invoice-price mb-5 ">
                    <div class="sub-price text-center" align="center">
                        <h2 class="text-inverse" style="font-weight:bold; padding:20px">Passenger Return Details</h2>
                    </div>
                </div>
                ...
                <div class="invoice-header">
                    <div class="invoice-from">
                        <table class="mt-3" width="100%">                        
                            <tr>
                            <td><h3 style="margin:0;">Pick Up Address:</h3></td>
                            <td><h3 style="margin:0;">{{$booking_details['return_pickup_address']}}</h3></td>
                            </tr>
                            <tr>
                            <td><h3 style="margin:0;">Drop Address:</h3></td>
                            <td><h3 style="margin:0;">{{$booking_details['return_drop_address']}}</h3></td>
                            </tr>
                            <tr>
                            <td><h3 style="margin:0;">Vehicle Number:</h3></td>
                            <td><h3 style="margin:0;">{{$booking_details['return_vehicle_number']}}</h3></td>
                            </tr>
                            <tr>
                            <td><h3 style="margin:0;">Passengers Count:</h3></td>
                            <td><h3 style="margin:0;">{{$booking_details['return_passengers_count']}}</h3></td>
                            </tr>
                            <tr>
                            <td><h3 style="margin:0;">Departure Date:</h3></td>
                            <td><h3 style="margin:0;">{{$booking_details['departure_date']}}</h3></td>
                            </tr>
                            <tr>
                            <td><h3 style="margin:0;">Departure Time:</h3></td>
                            <td><h3 style="margin:0;">{{$booking_details['departure_time']}}</h3></td>
                            </tr>
                            <tr>
                            <td><h3 style="margin:0;">Other Information:</h3></td>
                            <td><h3 style="margin:0;">{{$booking_details['other_information']}}</h3></td>
                            </tr>
                        </table>               
                    </div>                        
                </div>              
