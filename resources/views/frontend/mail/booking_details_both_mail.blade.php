    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="item">
                ...
                <td>
                    {{ $booking_details['return_pickup_address'] }}
                </td>
            </tr>
            <tr class="item">
                <td>
                ...
                <td>
                    {{ $booking_details['return_drop_address'] }}
                </td>
            </tr>
            <tr class="item">
                <td>
                ...
                <td>
                    {{ $booking_details['return_vehicle_number'] }}
                </td>
            </tr>
            <tr class="item">
                <td>
                ...
                <td>
                    {{ $booking_details['return_passengers_count'] }}
                </td>
            </tr>
            <tr class="item">
                <td>
            ...
            <tr class="item">
                ...
                <td>
                    {{ $booking_details['other_information'] }}
                </td>
            </tr>
        ...
        <p>Bookings are subject to our terms & conditions. We welcome all comments on the service we provide</p>
