                ...
                <div class="col-7 p-4 log">
                    ...
                    {{csrf_field()}}
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    <input type="text" class="form-control" id="first_name" aria-describedby="first_name" placeholder="First Name" required>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    <input type="text" class="form-control" id="phone" aria-describedby="phone" placeholder="Mobile Number" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    <input type="password" class="form-control" id="confirm_password" aria-describedby="confirm_password" placeholder="Confirm Password" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    <input type="text" class="form-control" id="city" aria-describedby="city" placeholder="Your City" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-6">
                                <button class="btn w-100 text-white" style="background-color: #FF9701">Login</button>
                            </div>
